...
if __name__ == '__main__':
    ...
    input = Path(r'C:\Users\LTZ26\Desktop\ANU_RunPKG_RunALLVer\pkg\data\output')

    for f in input.glob('*.flt'):
        output_tif = str(Path(r'C:\Users\LTZ26\Desktop\ANU_RunPKG_RunALLVer\tif_output').joinpath(f.stem + '.tif'))
